...
public class CDBiasUpdatesKernel extends Kernel implements Serializable
{
	...
	public CDBiasUpdatesKernel(Matrix hiddenBiasWeights, Matrix posPhase, Matrix negPhase, float learningRate, float momentum)
	{
		...
		this.miniBatchSize = posPhase.getRows();
	}
	...
	public void run()
	{
		...
		{
			weightUpdate += posPhase[posPhaseStartIndex + id * posPhaseColumnStep + i * posPhaseRowStep] - negPhase[negPhaseStartIndex + id * negPhaseColumnStep + i * negPhaseRowStep];
		}
