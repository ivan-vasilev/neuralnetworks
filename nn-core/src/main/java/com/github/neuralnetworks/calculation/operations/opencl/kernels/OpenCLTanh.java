...
public class OpenCLTanh extends OpenCLTensorFunction
{
	...
	public OpenCLKernelReference createKernel()
	{
		...
		int id = OpenCLCore.getInstance().Tanh(deviceId, tensorRef.getId(), tensor.getSize(), tensor.getStartIndex());
	...
	{
		return " -D THSI" + order + "=" + tensor.getStartIndex();
	}
}
