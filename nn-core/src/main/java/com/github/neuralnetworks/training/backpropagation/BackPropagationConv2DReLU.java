...
public class BackPropagationConv2DReLU extends BackPropagationConnectionCalculatorImpl {
	...
	if (con != null) {
	    connectionCalculators.put(con, new AparapiBackpropConv2DReLU(con, miniBatchSize, targetLayer));
	}
    }
	...
	public AparapiBackpropConv2DReLU(Conv2DConnection c, int miniBatchSize, Layer targetLayer) {
