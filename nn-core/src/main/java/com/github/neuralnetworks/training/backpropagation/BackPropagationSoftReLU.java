...
public class BackPropagationSoftReLU extends BackPropagationConnectionCalculator {
	...
	super(properties, new AparapiBackpropSoftReLUByRows(), new AparapiBackpropSoftReLUByColumns());
    }

    public static class AparapiBackpropSoftReLUByRows extends AparapiBackpropagationBaseByRows {
    ...
    public static class AparapiBackpropSoftReLUByColumns extends AparapiBackpropagationBaseByColumns {
