 ...
 * @author tmey
 */
public class ReluLayerBuilder extends NamedSingleInputLayerBuilder
{

	public static String DEFAULT_LAYER_NAME = "ReluLayer";

	public ReluLayerBuilder()
	{
	...
	{
		final StringBuilder sb = new StringBuilder("ReluLayerBuilder{");
