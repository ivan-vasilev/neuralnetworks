 ...
 *         Configuration: 2 Fully connected + 1 Convolutional (0 padding, 1 stride) + max pooling
 *         5.88%% Test error 1 epoch
 */
public class Mnist1Conv2FCPooling extends JUnitOnServerStarter
{
	...
	{
		JUnitOnServerStarter jUnitOnServerStarter = new Mnist1Conv2FCPooling();
