 ...
 * @author Urko
 */
public class CifarServerTest extends JUnitOnServerStarter
{
	...
	public void jUnitTest(int epochs, String folder)
	{
		...
		// network
		{
			...
			// conv
			{
				...
				convolutionalLayerBuilder.setBiasLearningRate(0.001f);
...
//		   // conv
			...
			// fc
			{
				...
				fullyConnectedLayerBuilder.setBiasLearningRate(0.001f);
	...
	{
		JUnitOnServerStarter jUnitOnServerStarter = new CifarServerTest();
