 ...
 *         Configuration: 1FC (10 neurons) layers
 *         8.29% Test error 1 epoch
 */
public class Mnist1FC extends JUnitOnServerStarter
{
	...
	public static void main(String[] args)
	{
		...
		JUnitOnServerStarter jUnitOnServerStarter = new Mnist1FC();
