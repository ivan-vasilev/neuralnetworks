 ...
 *         Configuration: 1 Fully connected + 1 Convolutional (0 padding, 1 stride) + max pooling
 *         7.8100004%% Test error 1 epoch
 */
public class Mnist1Conv1FCPooling extends JUnitOnServerStarter
{
	...
	{
		JUnitOnServerStarter jUnitOnServerStarter = new Mnist1Conv1FCPooling();
