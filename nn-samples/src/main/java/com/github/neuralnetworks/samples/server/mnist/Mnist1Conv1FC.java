 ...
 *         Configuration: 1 Fully connected + 1 Convolutional (0 padding, 1 stride) + no pooling
 *         8.97%% Test error 1 epoch
 */
public class Mnist1Conv1FC extends JUnitOnServerStarter
{
	...
	{
		JUnitOnServerStarter jUnitOnServerStarter = new Mnist1Conv1FC();
