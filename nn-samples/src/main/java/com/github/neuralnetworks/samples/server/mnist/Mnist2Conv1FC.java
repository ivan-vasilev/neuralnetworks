 ...
 *         Configuration: 1 Fully connected + 2 Convolutional (0 padding, 1 stride) + no pooling
 *         6.14% Test error 1 epoch
 */
public class Mnist2Conv1FC extends JUnitOnServerStarter
{
	...
	{
		JUnitOnServerStarter jUnitOnServerStarter = new Mnist2Conv1FC();
